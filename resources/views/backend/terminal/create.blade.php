            ...
            <div class="card-body">
                <form action="{{ route('terminal.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Masukkan Nama Terminal.." required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="address" id="address" class="form-control" rows="4" placeholder="Masukkan Alamat Terminal" required></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="facilities" id="facilities" class="form-control" rows="4" placeholder="Masukkan Fasilitas Terminal" required></textarea>
                    </div>
