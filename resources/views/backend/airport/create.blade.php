...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('airport.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="mb-3">
                        <label for="name" class="form-label">Nama Bandara</label>
                        <input type="text" name="name" id="name" class="form-control" placeholder="Masukkan Nama Bandara.." required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="address" id="address" class="form-control" rows="4" placeholder="Masukkan Alamat Bandara" required></textarea>
                    </div>

                    <div class="mb-3">
                        <label for="open_at" class="form-label">Jam Buka</label>
                        <input type="time" name="open_at" id="open_at" class="form-control" required>
                    </div>

                    <div class="mb-3">
                        <label for="closed_at" class="form-label">Jam Tutup</label>
                        <input type="time" name="closed_at" id="closed_at" class="form-control" required>
                    </div>

                    <div class="mb-3">
                        <label for="facilities" class="form-label">Fasilitas</label>
                        <textarea name="facilities" id="facilities" class="form-control" rows="4" placeholder="Masukkan Fasilitas Bandara" required></textarea>
                    </div>
