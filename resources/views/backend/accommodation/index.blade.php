        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center">
                    ...
                    Tabel Data
                    <a href="{{ route('accommodation.create') }}" class="btn btn-primary btn-sm ms-auto">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu"
                                                ...
                                                <li><a class="dropdown-item"
                                                        href="{{ route('accommodation.show', $item->id) }}">Lihat</a></li>
                                                <li><a class="dropdown-item"
                                                        href="{{ route('accommodation.edit', $item->id) }}">Edit</a></li>
                                                <li>
                                                    <form action="{{ route('accommodation.destroy', $item->id) }}"
